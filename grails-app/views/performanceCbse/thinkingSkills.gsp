    ...
    $( function () {
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                name: 'School Average',
                data: [0.00,0.00,0.00,0.00,80.78,84.00,76.61,90.00,0.00,88.57,0.00,84.00,0.00,76.61,92.50,88.57,64.71,76.44,80.34,90.00]
            }]
        });
            ...
            <!-- Column Chart-->
	           $(function () {
			    $('#container2').highcharts({
			        ...
			        series: [{
			            name: 'CBSE Average',
			            data: [0.00,0.00,0.00,0.00,73.83,76.41,89.46,90.51,73.83,73.83,76.41,76.41,89.46,89.46,90.51,90.51,69.97,73.27,87.78,89.02]
           ...
           $('#chart').highcharts({
                ...
                series: [{
                    name: 'State Average',
                    data: [0.00,0.00,0.00,0.00,80.07,83.00,92.63,93.68,80.07,80.07,83.00,83.00,92.63,92.63,93.68,93.68,74.08,78.85,90.86,91.88]
                }, {
                    name: 'School Average',
                    data: [0.00,0.00,0.00,0.00,80.78,84.00,76.61,90.00,0.00,88.57,0.00,84.00,0.00,76.61,92.50,88.57,64.71,76.44,80.34,90.00]
                }]
