            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Class X Performance</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                       <!-- Prediction box -->
            		   <div class="col-lg-12 " >
	            		   <iframe src="http://analytics.amritacreate.org/eGAPAnalytics/views/analytics.statistical/ui/bootstrapPrediction.jsp"></iframe>	
            		   </div>
                      <!-- /.box -->  
                    </div><!-- /.row (main row) -->
