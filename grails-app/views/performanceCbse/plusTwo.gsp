    ...
    <body class="skin-blue">
           	...
           	<aside class="right-side">
            	<section class="content-header">
                   ...
                   <ol class="breadcrumb">
                       ...
                       <li><a href="javascript:"><i class="fa fa-area-chart"></i> Performance</a></li>
                       <li class="active">Co-Scholastic</li>
                   </ol>
               </section>
                  <section class="col-lg-6 connectedSortable active"><h4>Select School</h4>
						<div class="dropdown">
					...
					<section class="col-lg-6 connectedSortable active"><h4>Select Subject</h4>
						<div class="dropdown">
						  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">
						   Select
						    <span class="caret"></span>
						  </button>
						  <ul id="subjSel" class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
						  
						    <li><g:link  controller="performanceCbse" action="physics">Physics</g:link></li>
		...
		<script>
			$('document').ready(function(){
				$("#subjSel").find("a").bind("click",function(){
					window.location = $(this).attr("href");	
				});
				$("#subjSel li").eq(0).find("a").trigger("click");
			});
		</script>
