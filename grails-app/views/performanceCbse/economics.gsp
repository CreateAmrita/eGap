        ...
        $( function () {
            ...
            $('#container').highcharts({
                ...
                series: [{
                    ...
                    data: [55.34,54.05,52.24,52.96,54.09,53.63]
                }, {
                    name: 'School Average',
                    data:[0.00,0.00,38.44,52.82,46.33,48.63]
                }]
            });
            ...
            <!-- Line chart-->
			    ...
			    $('#container2').highcharts({
			        ...
			        series: [{
			            name: 'CBSE Average',
			            data: [59.92,60.45,60.45,60.40,59.86,63.34]
			
			        }, {
			             name: 'School Average',
	                     data: [0.00,0.00,62.00,79.71,75.17,62.31]
            ...
            $('#chart').highcharts({
                ...
                series: [{
                    name: 'State Average',
                    data: [57.95,56.86,57.98,59.90,56.68,58.91]
                }, {
                    name: 'School Average',
                    data: [0.00,0.00,8.44,52.82,46.33,48.63]
                }]
            });
