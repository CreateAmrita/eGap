        ...
        $( function () {
            ...
            $('#container').highcharts({
                ...
                series: [{
                    ...
                    data: [62.14,59.54,59.98,61.72,63.49,65.12]
                }, {
                    name: 'School Average',
                    data:[0.00,0.00,61.56,57.53,54.79,80.56]
                }]
            });
            ...
            <!-- Line chart-->
			    ...
			    $('#container2').highcharts({
			        ...
			        series: [{
			            name: 'CBSE Average',
			            data: [59.77,57.60,57.07,59.01,62.28,63.47]
			
			        }, {
			             name: 'School Average',
	                     data: [0.00,0.00,15.01,16.30,18.49,12.14]
            ...
            $('#chart').highcharts({
                ...
                series: [{
                    name: 'State Average',
                    data: [80.39,71.81,73.00,71.25,68.69,75.48]
                }, {
                    name: 'School Average',
                    data: [0.00,0.00,61.56,57.53,54.79,80.56]
                }]
