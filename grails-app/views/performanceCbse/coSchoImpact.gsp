            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <div class="row">
                       <!-- Prediction box -->
            		   <div class="col-lg-12 " >
	            		   <iframe src="http://analytics.amritacreate.org/eGAPAnalytics/views/analytics.predictive/ui/aprioriVisualization.jsp"></iframe>	
            		   </div>
                      <!-- /.box -->  
                    </div><!-- /.row (main row) -->
