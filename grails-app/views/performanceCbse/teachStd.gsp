        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Trained Teacher Vs Students
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="javascript:"><i class="fa fa-line-chart"></i> CBSE Insights</a></li>
                        <li class="active">Trained Teacher Vs Students</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                       <!-- Prediction box -->
            		   <div class="col-lg-12 " >
	            		   <iframe src="http://analytics.amritacreate.org/eGAPAnalytics/views/analytics.statistical/ui/studteacherRatio.jsp"></iframe>	
            		   </div>
                      <!-- /.box -->  
                    </div><!-- /.row (main row) -->
