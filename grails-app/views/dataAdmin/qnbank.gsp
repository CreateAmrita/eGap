            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active">
                            <g:link controller="dashboard" action="index_new">
                    ...
                    <div class="row">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-header">
                                        <div class="box-tools">
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn btn-primary"><i class="fa fa-check-circle-o" style="color:#fff !important;"></i> Refine</button>
                                            </div>
                                        </div>
                                    </div><!-- /.box-header -->
                                    <!-- /.box-body -->
                        ...
                        <section class="col-lg-9 connectedSortable">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <th>Question</th>
                                            <th style="width: 140px">Hint</th>
                                            <th style="width: 140px">Edit</th>
                                            <th style="width: 140px">Delete</th>
                                        </tr>
                                        <tr>
                                            <td>1.</td>
                                            <td>Smallest bone in our body is <input type="text" class="form-control col-xs-2" placeholder="Answer..."></td>
                                            <td valign="middle">
                                                <a href="javascript:"><i class="fa fa-question"></i></a>
                                            </td>
                                            <td valign="middle"><a href="javascript:"><i class="fa fa-edit"></i></a></td>
                                            <td valign="middle"><a href="javascript:"><i class="fa fa-close"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td>2.</td>
                                            <td>Number of bones in a human body?
                                        ...
                                        <tr>
                                            <td>3.</td>
                                            <td>Largest bone in body is <select class="form-control">
                                                <option>option 1</option>
                                                <option>option 2</option>
                                                <option>option 3</option>
                                                <option>option 4</option>
							 ...
							 <div class="row pad">
									<button class="btn bg-orange pull-right margin">Evaluate</button>
							 </div>
                        </section><!-- right col -->
                    </div><!-- /.row (main row) -->
