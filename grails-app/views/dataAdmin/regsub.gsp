            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Registered Subjects</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-header">
                                        <div class="box-tools">
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn bg-olive"><i class="fa fa-download" style="color:#fff !important;"></i> Download</button>
                                                <button class="btn bg-orange"><i class="fa fa-upload" style="color:#fff !important;"></i> Upload</button>
                                            </div>
                                        </div>
                                    </div><!-- /.box-header -->
                                    <!-- /.box-body -->
                        ...
                        <section class="col-lg-9 connectedSortable">
							<div class="col-xs-12">
                                <div class="box">                                                                    
                                    <div class="box-header">
                                        <h3 class="box-title">Subject Registered</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body table-responsive no-padding">
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td>Abhijith</td>
                                                <td><a href="javascript:"><i class="fa fa-check"></i></a></td>
                                                <td><a href="javascript:"><i class="fa fa-check"></i></a></td>
                                                <td><a href="javascript:"><i class="fa fa-close"></i></a></td>
                                                <td><a href="javascript:"><i class="fa fa-check"></i></a></td>
                                                <td><a href="javascript:"><i class="fa fa-check"></i></a></td>
                                                <td><a href="javascript:"><i class="fa fa-check"></i></a></td>
                                                <td><a href="javascript:"><i class="fa fa-close"></i></a></td>
