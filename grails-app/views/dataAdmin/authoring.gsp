                                ...
                                <div class="box">
                                    ...
                                    <div class="box-header">
                                        <div class="box-tools">
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn btn-primary"><i class="fa fa-check-circle-o" style="color:#fff !important;"></i> Refine Content</button>
                                            </div>
                                        </div>
                                    </div><!-- /.box-header -->
                                    <!-- /.box-body -->
                            ...
                            <div class='row'>
                                <div class='col-md-12'>
                                    <div class='box box-info'>
                                        ...
                                        <div class='box-header grey-bg'>
                                            <h4 class='box-title'>Section 1</h4>
                                            <!-- tools box -->
                                        ...
                                        <div class='box-body pad'>
                                            <form>
												<textarea class="textarea" placeholder="Author your lessons" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                                <div class="row pad">
                                            		<button class="btn bg-orange pull-right margin">Submit</button>
                                                </div>
                                            </form>  
                                        </div>    
                                    </div><!-- /.box -->                            
