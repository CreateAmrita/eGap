							...
							<div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header">
                                        <h3 class="box-title">Filter Year</h3>
                                    </div>                                
                                    <div class="box-header">
                                        <div class="box-tools">
                                            <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn btn-primary"><i class="fa fa-check-circle-o" style="color:#fff !important;"></i> Filter</button>
                                            </div>
                                        </div>
                                    </div><!-- /.box-header -->
                                    <!-- /.box-body -->
        ...
        <script>
			$(function() {
					...
					var bar = new Morris.Bar({
						...
						resize: true,
						data: [
							{y: 'FA1', FA1: 3, FA2: 7, FA3: 6, FA4: 9},
							{y: 'FA2', FA1: 5, FA2: 6, FA3: 4, FA4: 7},
							{y: 'FA3', FA1: 2, FA2: 4, FA3: 8, FA4: 4},
							{y: 'FA4', FA1: 7, FA2: 5, FA3: 4, FA4: 9}
						],
						barColors: ['#00b3ff', '#ffcc00', '#8bbc21', '#ff0000'],
						xkey: 'y',
						ykeys: ['FA1', 'FA2', 'FA3', 'FA4'],
						labels: ['Mathematics', 'Social Science', 'Science', 'Sanskrit'],
						hideHover: 'none'
					});
				});
        </script>
