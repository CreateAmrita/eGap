...
<html>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Student Transfer Report</li>
                    </ol>
                </section>
                       ...
                       <section class="col-md-6 connectedSortable">
                            <div class="box ">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Student Transfer Report</h3>
                                </div>
	...
	var selectClass = function(){
		$("#className").html("");
		var p_data="school_Id="+$("#SchlId").val()+"&acYrId="+$("#academicYear").find("option:selected").val();
		$.ajax({
	...
	var fetchStudentDetails = function(){
		$("#studentList").html("");
			var p_data = "academicYrId="+$("#academicYear").find("option:selected").val()+"&classMasterId="+$("#className").find("option:selected").data("classmasterid")+"&schoolId="+$("#SchlId").val();
			$.ajax({
				url: "${grailsApplication.config.grails.serverURL}/CCE/stdFinalTransferRpt",
				data : p_data,
				beforeSend: function(){
