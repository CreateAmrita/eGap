...
<html>
                        ...
                        <section class="col-md-6">
	                            <div class="box ">
	                                <div class="box-header">
	                                    ...
	                                    <div id="headline" >
	                                    <h3 class="box-title">Student Optional Subject Report</h3></div>
	                                </div>
	...
	var goBack = function(){
		$("#headline").html("<h3 style='font-size: 20px; font-weight: 400; margin: 0; padding: 10px 10px 10px 10px;'>Student Optional Subject Report</h3>")
		fetchStudentDetails();
	}
