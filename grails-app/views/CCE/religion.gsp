            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Religion Analytics</li>
                    </ol>
                </section>
	                ...
	                <div class="row">
						<div class="col-md-12">
							<div class="callout callout-info" style="margin-bottom: 1em!important;">
						        <h3>Percentage Distribution of Religion</h3>
						    </div>
						</div>
					</div>
						...
						<div class="col-md-6">
							...
							<div class="box ">
								...
								<!-- tools box -->
									...
									<h3 class="box-title">Religion Analytics</h3>
								</div>
...
//				$.ajax({url: "${grailsApplication.config.grails.serverURL}/CCE/rClusterStates",
//					data : data,
//					success:function(data){
...
//			});
			...
			$('#Cluster').change(function() {
				fetchReligionDetails();
			});

			var fetchReligionDetails = function(){
				$(".box").show();
				...
				$.ajax({
					url: "${grailsApplication.config.grails.serverURL}/CCE/religionReport",
					data : p_data,
					beforeSend: function(){
					...
					success:function(data){
						...
						$('#container').highcharts({
				            ...
				            title: {
				                text: 'Percentage distribution of Religion'
				            },
				            tooltip: {
