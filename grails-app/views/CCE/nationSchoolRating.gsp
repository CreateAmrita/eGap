	                ...
	                <div class="row">
						<div class="col-md-12">
							<div class="callout callout-info" style="margin-bottom: 1em!important;">
						        <h3>Nation Wide Rating of Schools</h3>
						    </div>
						</div>
					</div>
						...
						<div class="col-md-6">
							...
							<div class="box ">
								...
								<!-- tools box -->
									...
									<h3 class="box-title">Nation Wide School Rating</h3>
								</div>
		...
		<script language="javascript">		
		 <sec:ifAllGranted roles="ROLE_CCEADMIN">
			...
			var fetchSchoolDetails = function(){
				...
				$.ajax({
					url: "${grailsApplication.config.grails.serverURL}/CCE/schoolRating",
					data : p_data,
					beforeSend: function(){
						...
						$('#container').html("").css({'min-width': '310px', 'height': '400px', 'margin': '0 auto'})
						 $('#container').highcharts({
							 chart: {
						        ...
						        title: {
						        	 text: 'Nation Wide School Rating'
						        },
						        xAxis: {
