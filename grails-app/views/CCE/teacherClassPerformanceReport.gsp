       ...
       <!-- header logo: style can be found in header.less -->
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Teacher Class Performance</li>
                    </ol>
                </section>
	                       ...
	                       <div class="col-md-6">
	                            <div class="box ">
	                                <div class="box-header">
	                                    ...
	                                    <h3 class="box-title">Teacher Class Performance Report</h3>
	                                </div>
        ...
        <script>
			...
			var fetchStudentDetails = function(){
					...
					console.log(p_data);
					$.ajax({
						url: "${grailsApplication.config.grails.serverURL}/CCE/teacherClassPerformanceRpt",
						data : p_data,
						beforeSend: function(){
