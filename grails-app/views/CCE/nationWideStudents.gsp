        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="javascript:"><i class="fa fa-dashboard"></i> Students</a></li>
                        <li class="active">Nation Wide Students</li>
                    </ol>
                </section>
						...
						<div class="col-md-6">
							...
							<div class="box ">
								...
								<!-- tools box -->
									...
									<h3 class="box-title">Nation Wide Students</h3>
								</div>
		...
		<script language="javascript">		
		 <sec:ifAllGranted roles="ROLE_CCEADMIN">
			...
			var fetchSchoolDetails = function(){
				...
				$.ajax({
					url: "${grailsApplication.config.grails.serverURL}/CCE/nationStudents",
					data : p_data,
					beforeSend: function(){
