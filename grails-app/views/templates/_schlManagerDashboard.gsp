              		...
              		<div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h3>
                                        73<sup style="font-size: 20px">%</sup>
                                    </h3>
                                    <p>
                                        Pass percentage School Group wide
                                    </p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    ...
                                    <p>
                                        Amrita Vidhyalayam schools registred
                                    </p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="" class="small-box-footer">
                                    Reschedule <i class="ion ion-refresh"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                       			...
                       			<div class="box ">
									<div class="box-header">
										...
										<div class="pull-right box-tools">
											<button class="btn  btn-sm daterange pull-right" data-toggle="tooltip" title="Date range" style="margin-right: 5px;"><i class="fa fa-calendar" ></i></button>
								 ...
								 <div class="box ">
									 ...
									 <div class="box-body chart-responsive">
										 <ul class="timeline">
											...
											<!-- timeline time label -->
											<li class="time-label">
												<span class="bg-blue"> 04 Feb 2017 </span>
											</li>
											<!-- /.timeline-label -->
											...
											<li>
												...
												<i class="fa fa-envelope bg-blue"></i>
													<div class="timeline-item">
														...
														<h3 class="timeline-header"><a href="#">Invite for conference with CDAC</a> ...</h3>
														<div class="timeline-body">
															Meeting scheduled on 4th Feb of 2017 with CDAC. Should you accept it? 
														</div>
											
														<div class='timeline-footer'>
															<a class="btn btn-primary btn-xs">Yes</a>
											...
											<!-- timeline time label -->
											<li class="time-label">
												<span class="bg-red"> 09 Mar 2017 </span>
											</li>
											<!-- /.timeline-label -->
											...
											<li>
												<!-- timeline icon -->
												<i class="fa fa-pencil bg-red"></i>
													<div class="timeline-item">
														<span class="time"><i class="fa fa-clock-o"></i> 10.00</span>
											
														<h3 class="timeline-header"><a href="#">Commencement of Annual Examination</a> ...</h3>
														<div class="timeline-body">
															Annual Examination for class 10th is scheduled on 9th March of 2017.
														</div>
											
														<div class='timeline-footer'>
															<button class="btn btn-warning btn-xs"><i class="fa fa-clock-o"></i> Set Reminder</button>
														</div>
													</div>
											</li>
											<!-- END timeline item -->
											...
											<li>
												<!-- timeline icon -->
												<i class="fa fa-clock-o bg-default"></i>
											</li>   
										</ul>
									  </div><!-- /.box-body -->
								 </div>
                        ...
                        <section id="sectionRight" class="col-lg-6 connectedSortable">
							...
							<div class="box ">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Pass percentage Versus Average</h3>
                                </div>
                                <div class="box-body chart-responsive">
                                    <div id="avg" style=" height: 400px; margin: 0 auto"></div>
                                </div><!-- /.box-body -->
                            </div>   
                            <!-- /.box -->
                            ...
                            <div class="box ">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Students gender ratio</h3>
                                </div>
                                <div class="box-body chart-responsive">
                                    <div class="chart" id="pie-chart" style="height: 200px;"></div>
                                </div><!-- /.box-body -->
                            </div>
