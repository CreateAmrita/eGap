    ...
    <body>
        ...
        <div class="center">
            ...
            <div class="lockscreen-item">
                ...
                <g:form controller='dashboard' action='index' method='POST' id='' class='' autocomplete='on'>
                    <div class="body">
                        <div class="form-group">
                            <input type="text" name='j_username' id='username' tabindex="1" class="form-control" placeholder="Username"/>
                        </div>
                        <div class="form-group">
