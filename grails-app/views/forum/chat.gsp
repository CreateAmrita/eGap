                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                         ...
                         <li class="treeview">
                            <a href="javascript:">
                                <i class="fa fa-bar-chart-o"></i> <span>CCE</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
            ...
            <!-- Right side column. Contains the navbar and content of the page -->
              <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="javascript:"><i class="fa fa-twitch"></i> Forums</a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Talk with our online educators</h3>
                                    ...
                                    <div class="box-body chat" id="chat-box">
                                        <!-- chat item -->
                                        <div class="item">
                                            <img src="${resource(dir:'egov_img',file:'avatar.png')}" alt="user image" class="online"/>
                                            <p class="message">
                                                <a href="#" class="name">
                                                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 2:15</small>
                                                    Ashish Mohan
                                                </a>
                                                 Can a teacher define new indicators for Co-scholastics?
                                            </p>
                                        ...
                                        <!-- chat item -->
                                        <div class="item">
                                        	<img src="${resource(dir:'egov_img',file:'avatar2.png')}" alt="user image" class="offline"/>
                                            <p class="message">
                                                <a href="#" class="name">
                                                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 5:15</small>
                                                    Amrita Jayakumar
                                                </a>
                                                There are many CBSE pre-defined indicators. It is desirable to use those.
                                            </p>
                                        </div><!-- /.item -->
                                        <!-- chat item -->
                                    </div><!-- /.chat -->
                                    <div class="box-footer">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Ask your clarifications..."/>
