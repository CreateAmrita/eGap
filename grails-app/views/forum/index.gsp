							...
							<div class="col-xs-12">
                                ...
                                <div class="box">                                                                    
                                    <div class="box-header">
                                        <h3 class="box-title">CBSE News and Announcements</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body table-responsive no-padding">
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tr>
                                                <td>Continous ans Compherensive Evaluation</td>
                                                <td>8,543</td>
                                                <td>CBSE HQ, New Delhi</td>
                                                <td>12/08/2014</td>
                                            </tr>
                                            <tr>
                                                <td>CSBE endorsed use of Amrita Online Labs</td>
                                                <td>12,000</td>
                                                <td>CBSE HQ, New Delhi</td>
                                                <td>2/1/2015</td>
                                            </tr>
								...
								<div class="box">                                                                    
                                    <div class="box-header">
                                        <h3 class="box-title">Assessment Issues</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body table-responsive no-padding">
                                        <table class="table table-hover table-striped">
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Introduction of PSA</td>
                                                <td>9,784</td>
                                                <td>CBSE</td>
                                                <td>1/1/2015</td>
                                            </tr>
                                            <tr>
                                                <td>Guidelines for FA activities</td>
                                                <td>4,658</td>
                                                <td>Amrita Vidyalayam, Calicut</td>
                                                <td>27/09/2014</td>
                                            </tr>
                                        </table>
                                    </div><!-- /.box-body -->
