    ...
    <body class="skin-blue">
            		...
            		<div class="col-lg-2 " >
	            		...
	            		<div class="col-lg-8 " >
	            			<section class="content-header">
							    ...
							    <ol class="breadcrumb">
			                        <li><g:link controller="ratings" action="acadRept" onclick="setParams(this);"><i class="fa fa-home"></i>School Details</g:link></li>
			                    </ol>
							</section>
							...
							<section class="content">
								...
								<input type="text" name="zoneId" id="zoneId" value="${zoneId}" class="hide"/>
								<input type="text" name="regionId" id="regionId" value="${regionId}" class="hide"/>
								<input type="text" name="clusterId" id="clusterId" value="${clusterId}" class="hide"/>
								<input type="text" name="state" id="state" value="${state}" class="hide"/>
							</section>
	            		</div>
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAe45vAXLQqSFQLNeiQbCo9p7r_4lQbjQc&callback=initMap" type="text/javascript"></script>
		   ...
		   var initialize =	function(lat,lng){
			...
			var setParams = function(thisObj){
				var zoneId = $('#zoneId').val()
				var regionId = $('#regionId').val()
				var clusterId = $("#clusterId").val()
				var state = $("#state").val();
				href = $(thisObj).attr("href").split("?");
				var p_data="?zoneId="+zoneId+"&regionId="+regionId+"&clusterId="+clusterId+"&state="+state;
