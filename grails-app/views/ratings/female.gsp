    ...
    <body class="skin-blue">
        ...
        $(function () {
            ...
            $('#container').highcharts({
                title: {
                    text: 'Prediction for stream selection - Female',
                    x: -20 //center
                },
                ...
                series: [{
                    name: 'Arts',
                    data: [7324.336,7264.019,7207.97,7157.609,7112.812,7073.02,7037.596,7005.945,6977.545,6951.949,6928.782]
                }, {
                    name: 'Commerce',
                    data: [8149.338,8196.18,8245.61,8295.517,8344.467,8391.57,8171.763,8198.382,8224.98,8251.312,8277.196]
                }, {
                    name: 'Science',
                    data: [10443.863,10421.588,10400.274,10379.524,10359.139,10339.054,10436.177,10426.53,10416.841,10407.099,10397.311]
                }]
            });
        });
        </script>
