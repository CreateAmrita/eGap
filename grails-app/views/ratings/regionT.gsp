    ...
    <body class="skin-blue">
        ...
        $(function () {
            $('#container').highcharts({
                title: {
                    text: 'Prediction for stream selection - Region "T"',
                    x: -20 //center
                },
                ...
                series: [{
                    name: 'Arts',
                    data: [33.58742733,32.73446556,32.05680437,31.5087022,31.05756898,30.6803737,]//30.36062639,30.08630097,29.84845878,29.64033514,29.45672517]
                }, {
                    name: 'Commerce',
                    data: [33.87097016,35.57080565,37.17000587,38.67600147,40.09684184,41.44049709]//,34.58348527,35.30187839,36.00089208,36.68153192,37.34477705]
                }, {
                    name: 'Science',
                    data: [232.4265312,226.5950374,221.9790151,218.2257129,215.109926,212.4807102]//,229.3208627,226.793451,224.5171884,222.4565059,220.5824585 	]
                }]
            });
        });
