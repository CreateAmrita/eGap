    ...
    <body class="skin-blue">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                         ...
                         <li class="treeview">
                            <a href="javascript:">
                                <i class="fa fa-twitch"></i> <span>CCE</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                            	<li><g:link controller="CCE" action="classSubjAnalysisReport"><i class="fa fa-angle-double-right"></i>  Class Reports </g:link></li>
                            	<li><g:link controller="CCE" action="studPositionReport"><i class="fa fa-angle-double-right"></i>  Teacher Reports</g:link></li>
                            	<li><g:link controller="CCE" action="classPerformanceReport"><i class="fa fa-angle-double-right"></i>  Student Reports</g:link></li>
                            </ul>
                        </li>
        ...
        $(function () {
            $('#container').highcharts({
                title: {
                    text: 'Prediction for stream selection - Region "D"',
                    x: -20 //center
                },
                ...
                series: [{
                    name: 'Arts',
                    data: [1128.892111,1133.584113,1137.954354,1141.887458,1145.39044,1148.505317]//,1151.280693,1153.762381,1155.990696,1158.000141,1159.819919]
                }, {
                    name: 'Commerce',
                    data: [860.0997376,874.2186127,884.9849979,893.4854638,900.3760227,906.0771103]//,867.6928151,873.7478827,879.1085223,883.8874992,888.1739402]
                }, {
                    name: 'Science',
                    data: [684.3813894,691.8528566,699.0274786,705.929984,712.5756854,718.9739247]//,690.3467688,693.7340421,697.0700514,700.3541721,703.5855371]
                }]
            });
        });
