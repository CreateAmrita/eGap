    ...
    <body class="skin-blue">
        ...
        $(function () {
            $('#container').highcharts({
                title: {
                    text: 'Prediction for stream selection - Region "M"',
                    x: -20 //center
                },
                ...
                series: [{
                    name: 'Arts',
                    data: [44.40186706,43.37333633,42.54581465,41.87242103,41.31640758,40.85073112]//,40.4556207,40.11648396,39.82239498,39.5650463,39.33802613]
                }, {
                    name: 'Commerce',
                    data: [60.70209055,63.12539692,65.39889067,67.53452645,69.54510363,71.44314444]//,61.57859487,62.59919356,63.59095689,64.55552642,65.49448541]
                }, {
                    name: 'Science',
                    data: [264.69926,264.5709031,264.4230142,264.2640474,264.1012179,263.9401134]//,264.2640474,264.1555437,264.0470975,263.9401134,263.835678]
                }]
            });
        });
