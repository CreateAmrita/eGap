    ...
    <body class="skin-blue">
                       ...
                       <section class="col-lg-12  connectedSortable">
                            <div class="box ">
                                <div class="box-header">
                                    ...
                                    <i class="fa fa-line-chart"></i>
                                    <h3 class="box-title">Gender based prediction</h3>
                                </div>
        ...
        $(function () {
            $('#container').highcharts({
                title: {
                    text: 'Prediction for stream selection - Male',
                    x: -20 //center
                },
                ...
                series: [{
                    name: 'Arts',
                    data: [7952.644,8029.353,8097.571,8158.388,8212.798,8261.673,8305.76,8345.7,8382.034,8415.222,8445.657
        ]
                }, {
                    name: 'Commerce',
                    data: [11207.677,11170.42,11133.034,11095.75,11058.795,11022.377,10986.669,10951.813,10917.914,10885.044,10853.248]
                }, {
                    name: 'Science',
                    data: [13263.17,13132.921,13013.005,12902.433,12800.285,12705.725,12618.001,12536.437,12460.429,12389.434,12322.969]
                }]
            });
        }); 	
        </script>
